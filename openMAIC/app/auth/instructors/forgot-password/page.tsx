 ...
 *
 * Features:
 * - Visual step indicator (mobile + desktop)
 * - Sticky back button
 * - Shows email confirmation after submission
 * - Resend link option
 * - Security signals (lock icons, expiry badge)
 * - Mobile optimized
 */
...
export default function ForgotPasswordPage() {
  ...
  const handleRequestReset = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('/api/instructor/forgot-password', {
        method: 'POST',
